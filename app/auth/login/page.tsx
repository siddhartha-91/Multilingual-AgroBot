...
export default function LoginPage() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/agro-bg.jpg')" }}   // FULL PAGE BACKGROUND
    >
      ...
      <div className="relative z-10 w-[95%] max-w-6xl rounded-3xl shadow-2xl overflow-hidden flex border border-green-300">
        ...
        >
          {/* Semi-transparent mask to make text readable */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-center mt-6">
              <Link href="/auth/phone" className="text-green-700 font-semibold hover:underline">
        ...
        {/* RIGHT PANEL — FULL FARMERS IMAGE */}
